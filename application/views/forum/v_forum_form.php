  ...
  <div class="col-md-8">
    <div class="form-group form-group-lg">
      <label>Judul</label>
      <input type="text" name="judul" placeholder="Judul Pertanyaan" value="<?php if(isset($post->judul)){echo $post->judul;} ?>" required class="form-control">
    </div>
  </div>
  ...
  <div class="col-md-12">
    ...
    <div class="form-group">
      <label>Isi</label>
      <textarea name="isi" class="form-control" placeholder="Keterangan" id="keterangan"><?php  if(isset($post->judul)){echo $post->isi;}?></textarea>
    </div>
